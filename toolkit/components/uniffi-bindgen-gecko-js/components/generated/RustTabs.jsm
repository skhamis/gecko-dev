...
class TabsBridgedEngine {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            7, // tabs:tabs_b6f6_TabsBridgedEngine_last_sync
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            8, // tabs:tabs_b6f6_TabsBridgedEngine_set_last_sync
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            9, // tabs:tabs_b6f6_TabsBridgedEngine_sync_id
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            10, // tabs:tabs_b6f6_TabsBridgedEngine_reset_sync_id
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            11, // tabs:tabs_b6f6_TabsBridgedEngine_ensure_current_sync_id
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            12, // tabs:tabs_b6f6_TabsBridgedEngine_prepare_for_sync
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            13, // tabs:tabs_b6f6_TabsBridgedEngine_sync_started
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            14, // tabs:tabs_b6f6_TabsBridgedEngine_store_incoming
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            15, // tabs:tabs_b6f6_TabsBridgedEngine_apply
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        FfiConverterSequenceTypeGuid.checkType("uploadedIds", uploadedIds);
        return UniFFIScaffolding.callAsync(
            16, // tabs:tabs_b6f6_TabsBridgedEngine_set_uploaded
            FfiConverterTypeTabsBridgedEngine.lower(this),
            FfiConverterI64.lower(newTimestamp),
            FfiConverterSequenceTypeGuid.lower(uploadedIds),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            17, // tabs:tabs_b6f6_TabsBridgedEngine_sync_finished
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            18, // tabs:tabs_b6f6_TabsBridgedEngine_reset
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            19, // tabs:tabs_b6f6_TabsBridgedEngine_wipe
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
    }
    try {
...
class TabsStore {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            0, // tabs:tabs_b6f6_TabsStore_new
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            1, // tabs:tabs_b6f6_TabsStore_get_all
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            2, // tabs:tabs_b6f6_TabsStore_set_local_tabs
            FfiConverterTypeTabsStore.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            3, // tabs:tabs_b6f6_TabsStore_register_with_sync_manager
            FfiConverterTypeTabsStore.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            4, // tabs:tabs_b6f6_TabsStore_reset
            FfiConverterTypeTabsStore.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            5, // tabs:tabs_b6f6_TabsStore_sync
            FfiConverterTypeTabsStore.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            6, // tabs:tabs_b6f6_TabsStore_bridged_engine
            FfiConverterTypeTabsStore.lower(this),
        )
    }
    try {
...
}class FfiConverterSequenceTypeGuid extends FfiConverterArrayBuffer {
    static read(dataStream) {
        const len = dataStream.readInt32();
        const arr = [];
        for (let i = 0; i < len; i++) {
...
class FfiConverterTypeGuid extends FfiConverter {
