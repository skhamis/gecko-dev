...
export class RemoteSettings {
    ...
    static init(remoteSettingsConfig) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                7, // remote_settings:uniffi_remote_settings_fn_constructor_remotesettings_new
    ...
    downloadAttachmentToPath(attachmentId,path) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                8, // remote_settings:uniffi_remote_settings_fn_method_remotesettings_download_attachment_to_path
    ...
    getRecords() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                9, // remote_settings:uniffi_remote_settings_fn_method_remotesettings_get_records
                FfiConverterTypeRemoteSettings.lower(this),
            )
        }
        try {
    ...
    getRecordsSince(timestamp) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                10, // remote_settings:uniffi_remote_settings_fn_method_remotesettings_get_records_since
                FfiConverterTypeRemoteSettings.lower(this),
