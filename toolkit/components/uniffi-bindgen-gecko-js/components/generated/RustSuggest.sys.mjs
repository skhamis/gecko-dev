...
export class SuggestStore {
    ...
    static init(path,settingsConfig = null) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                12, // suggest:uniffi_suggest_fn_constructor_suggeststore_new
    ...
    clear() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                13, // suggest:uniffi_suggest_fn_method_suggeststore_clear
    ...
    clearDismissedSuggestions() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                14, // suggest:uniffi_suggest_fn_method_suggeststore_clear_dismissed_suggestions
                FfiConverterTypeSuggestStore.lower(this),
            )
        }
        try {
    ...
    dismissSuggestion(rawSuggestionUrl) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                15, // suggest:uniffi_suggest_fn_method_suggeststore_dismiss_suggestion
                FfiConverterTypeSuggestStore.lower(this),
    ...
    fetchGlobalConfig() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                16, // suggest:uniffi_suggest_fn_method_suggeststore_fetch_global_config
                FfiConverterTypeSuggestStore.lower(this),
            )
        }
        try {
    ...
    fetchProviderConfig(provider) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                17, // suggest:uniffi_suggest_fn_method_suggeststore_fetch_provider_config
                FfiConverterTypeSuggestStore.lower(this),
    ...
    ingest(constraints) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                18, // suggest:uniffi_suggest_fn_method_suggeststore_ingest
                FfiConverterTypeSuggestStore.lower(this),
    ...
    interrupt() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callSync(
                19, // suggest:uniffi_suggest_fn_method_suggeststore_interrupt
                FfiConverterTypeSuggestStore.lower(this),
            )
        }
        return handleRustResult(functionCall(), liftResult, liftError);
    ...
    query(query) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                20, // suggest:uniffi_suggest_fn_method_suggeststore_query
                FfiConverterTypeSuggestStore.lower(this),
...
export class SuggestStoreBuilder {
    ...
    static init() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                22, // suggest:uniffi_suggest_fn_constructor_suggeststorebuilder_new
            )
        }
        try {
            return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
    ...
    build() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                23, // suggest:uniffi_suggest_fn_method_suggeststorebuilder_build
    ...
    cachePath(path) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                24, // suggest:uniffi_suggest_fn_method_suggeststorebuilder_cache_path
                FfiConverterTypeSuggestStoreBuilder.lower(this),
                FfiConverterString.lower(path),
            )
        }
    ...
    dataPath(path) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                25, // suggest:uniffi_suggest_fn_method_suggeststorebuilder_data_path
                FfiConverterTypeSuggestStoreBuilder.lower(this),
                FfiConverterString.lower(path),
            )
        }
    ...
    remoteSettingsConfig(config) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                26, // suggest:uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_config
                FfiConverterTypeSuggestStoreBuilder.lower(this),
...
export function rawSuggestionUrlMatches(rawUrl,url) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callSync(
                28, // suggest:uniffi_suggest_fn_func_raw_suggestion_url_matches
