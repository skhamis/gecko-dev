...
class TodoList {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            92, // todolist:todolist_61e0_TodoList_new
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            93, // todolist:todolist_61e0_TodoList_add_item
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            94, // todolist:todolist_61e0_TodoList_add_entry
            FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            95, // todolist:todolist_61e0_TodoList_get_entries
            FfiConverterTypeTodoList.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            96, // todolist:todolist_61e0_TodoList_get_items
            FfiConverterTypeTodoList.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            97, // todolist:todolist_61e0_TodoList_add_entries
            FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            98, // todolist:todolist_61e0_TodoList_add_items
            FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            99, // todolist:todolist_61e0_TodoList_get_last_entry
            FfiConverterTypeTodoList.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            100, // todolist:todolist_61e0_TodoList_get_last
            FfiConverterTypeTodoList.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            101, // todolist:todolist_61e0_TodoList_get_first
            FfiConverterTypeTodoList.lower(this),
        )
    }
    try {
    ...
    const functionCall = () => {
        FfiConverterString.checkType("todo", todo);
        return UniFFIScaffolding.callAsync(
            102, // todolist:todolist_61e0_TodoList_clear_item
            FfiConverterTypeTodoList.lower(this),
            FfiConverterString.lower(todo),
        )
    }
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            103, // todolist:todolist_61e0_TodoList_make_default
            FfiConverterTypeTodoList.lower(this),
        )
    }
    try {
...
function getDefaultList() {
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            104, // todolist:todolist_61e0_get_default_list
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
...
function setDefaultList(list) {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            105, // todolist:todolist_61e0_set_default_list
...
function createEntryWith(todo) {
    ...
    const functionCall = () => {
        FfiConverterString.checkType("todo", todo);
        return UniFFIScaffolding.callAsync(
            106, // todolist:todolist_61e0_create_entry_with
            FfiConverterString.lower(todo),
        )
    }
    try {
