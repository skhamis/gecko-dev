...
class Sprite {
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            86, // sprites:sprites_1905_Sprite_new
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            87, // sprites:sprites_1905_Sprite_new_relative_to
    ...
    const functionCall = () => {
        return UniFFIScaffolding.callAsync(
            88, // sprites:sprites_1905_Sprite_get_position
    ...
    const functionCall = () => {
        ...
        return UniFFIScaffolding.callAsync(
            89, // sprites:sprites_1905_Sprite_move_to
            FfiConverterTypeSprite.lower(this),
    ...
    const functionCall = () => {
        FfiConverterTypeVector.checkType("direction", direction);
        return UniFFIScaffolding.callAsync(
            90, // sprites:sprites_1905_Sprite_move_by
            FfiConverterTypeSprite.lower(this),
            FfiConverterTypeVector.lower(direction),
        )
    }
...
function translate(position,direction) {
    ...
    const functionCall = () => {
        ...
        FfiConverterTypeVector.checkType("direction", direction);
        return UniFFIScaffolding.callAsync(
            91, // sprites:sprites_1905_translate
            FfiConverterTypePoint.lower(position),
            FfiConverterTypeVector.lower(direction),
        )
    }
