...
extern "C" {
  ...
  void uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure(void *, RustBuffer, RustCallStatus*);
...
Maybe<already_AddRefed<Promise>> UniFFICallAsync(const GlobalObject& aGlobal, uint64_t aId, const Sequence<ScaffoldingType>& aArgs, ErrorResult& aError) {
  switch (aId) {
    ...
    case 5: { // relevancy:uniffi_relevancy_fn_method_relevancystore_user_interest_vector
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<RustBuffer>, ScaffoldingObjectConverter<&kRelevancyRelevancyStorePointerType>>;
    ...
    case 6: { // remote_settings:uniffi_remote_settings_fn_clone_remotesettings
    ...
    case 7: { // remote_settings:uniffi_remote_settings_fn_constructor_remotesettings_new
    ...
    case 8: { // remote_settings:uniffi_remote_settings_fn_method_remotesettings_download_attachment_to_path
    ...
    case 9: { // remote_settings:uniffi_remote_settings_fn_method_remotesettings_get_records
    ...
    case 10: { // remote_settings:uniffi_remote_settings_fn_method_remotesettings_get_records_since
    ...
    case 11: { // suggest:uniffi_suggest_fn_clone_suggeststore
    ...
    case 12: { // suggest:uniffi_suggest_fn_constructor_suggeststore_new
    ...
    case 13: { // suggest:uniffi_suggest_fn_method_suggeststore_clear
    ...
    case 14: { // suggest:uniffi_suggest_fn_method_suggeststore_clear_dismissed_suggestions
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kSuggestSuggestStorePointerType>>;
    ...
    case 15: { // suggest:uniffi_suggest_fn_method_suggeststore_dismiss_suggestion
    ...
    case 16: { // suggest:uniffi_suggest_fn_method_suggeststore_fetch_global_config
    ...
    case 17: { // suggest:uniffi_suggest_fn_method_suggeststore_fetch_provider_config
    ...
    case 18: { // suggest:uniffi_suggest_fn_method_suggeststore_ingest
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kSuggestSuggestStorePointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 19: { // suggest:uniffi_suggest_fn_method_suggeststore_interrupt
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kSuggestSuggestStorePointerType>>;
    ...
    case 20: { // suggest:uniffi_suggest_fn_method_suggeststore_query
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<RustBuffer>, ScaffoldingObjectConverter<&kSuggestSuggestStorePointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 21: { // suggest:uniffi_suggest_fn_clone_suggeststorebuilder
    ...
    case 22: { // suggest:uniffi_suggest_fn_constructor_suggeststorebuilder_new
    ...
    case 23: { // suggest:uniffi_suggest_fn_method_suggeststorebuilder_build
    ...
    case 24: { // suggest:uniffi_suggest_fn_method_suggeststorebuilder_cache_path
    ...
    case 25: { // suggest:uniffi_suggest_fn_method_suggeststorebuilder_data_path
      using CallHandler = ScaffoldingCallHandler<ScaffoldingObjectConverter<&kSuggestSuggestStoreBuilderPointerType>, ScaffoldingObjectConverter<&kSuggestSuggestStoreBuilderPointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 26: { // suggest:uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_config
      using CallHandler = ScaffoldingCallHandler<ScaffoldingObjectConverter<&kSuggestSuggestStoreBuilderPointerType>, ScaffoldingObjectConverter<&kSuggestSuggestStoreBuilderPointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 27: { // suggest:uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_server
      using CallHandler = ScaffoldingCallHandler<ScaffoldingObjectConverter<&kSuggestSuggestStoreBuilderPointerType>, ScaffoldingObjectConverter<&kSuggestSuggestStoreBuilderPointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 28: { // suggest:uniffi_suggest_fn_func_raw_suggestion_url_matches
    ...
    case 29: { // tabs:uniffi_tabs_fn_clone_tabsbridgedengine
    ...
    case 30: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_apply
    ...
    case 31: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_ensure_current_sync_id
    ...
    case 32: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_last_sync
    ...
    case 33: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_prepare_for_sync
    ...
    case 34: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_reset
    ...
    case 35: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_reset_sync_id
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<RustBuffer>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 36: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_set_last_sync
    ...
    case 37: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_set_uploaded
    ...
    case 38: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_store_incoming
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 39: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_sync_finished
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 40: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_sync_id
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<RustBuffer>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 41: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_sync_started
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 42: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_wipe
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 43: { // tabs:uniffi_tabs_fn_clone_tabsstore
    ...
    case 44: { // tabs:uniffi_tabs_fn_constructor_tabsstore_new
    ...
    case 45: { // tabs:uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure
      ...
      return Some(CallHandler::CallAsync(uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure, aGlobal, aArgs, "uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure: "_ns, aError));
    }
...
bool UniFFICallSync(const GlobalObject& aGlobal, uint64_t aId, const Sequence<ScaffoldingType>& aArgs, RootedDictionary<UniFFIScaffoldingCallResult>& aReturnValue, ErrorResult& aError) {
  switch (aId) {
    ...
    case 45: { // tabs:uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsStorePointerType>, ScaffoldingConverter<RustBuffer>>;
      CallHandler::CallSync(uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure, aGlobal, aArgs, aReturnValue, "uniffi_tabs_fn_method_tabsstore_add_pending_remote_tab_closure: "_ns, aError);
      return true;
    }
    case 46: { // tabs:uniffi_tabs_fn_method_tabsstore_bridged_engine
      using CallHandler = ScaffoldingCallHandler<ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>, ScaffoldingObjectConverter<&kTabsTabsStorePointerType>>;
